...
area of interest and produces habitat maps, depth statistics, water
...
For the full package documentation and tutorials visit the [ReefMappeR
website](https://viktorikowskii.github.io/ReefMappeR/).
...
![Two-panel habitat map showing benthic habitats and geomorphic zones
with bathymetry as background.](reference/figures/habitat_map.png)

Two-panel habitat map showing benthic habitats and geomorphic zones with
bathymetry as background.
...
![NDCI map showing chlorophyll-a
distribution.](reference/figures/ndci.png)

NDCI map showing chlorophyll-a distribution.

![TSS map showing suspended sediment
distribution.](reference/figures/tss.png)

TSS map showing suspended sediment distribution.
...
![NDCI Change Classification
(2024-2025).](reference/figures/ndci_change.png)

NDCI Change Classification (2024-2025).

![TSS Change Classification
(2024-2025).](reference/figures/tss_change.png)

TSS Change Classification (2024-2025).
...
This package was developed as part of the course *Introduction to
Programming and Statistics for Remote Sensing and GIS* in the M.Sc.
[EAGLE](https://eagle-science.org/) program at the University of
Würzburg.
